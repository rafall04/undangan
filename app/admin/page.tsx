      ...
      <header className="ui-topbar">
        <div className="ui-container flex items-center justify-between py-3">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-900 text-sm font-bold text-white">R</span>
            <div className="leading-tight">
              <p className="text-sm font-semibold text-slate-900">Rafayana Admin</p>
              <p className="text-xs text-slate-500">{s.subject}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Link href="/admin/clients/new" className="ui-btn ui-btn-primary">
              + Undangan Baru
            </Link>
            <Link href="/admin/settings" className="ui-btn ui-btn-secondary">
              Pengaturan
            </Link>
            <AdminLogoutButton />
          </div>
